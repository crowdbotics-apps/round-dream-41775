"""
Django settings for round_dream_41775 project.
...
ROOT_URLCONF = 'round_dream_41775.urls'
...
WSGI_APPLICATION = 'round_dream_41775.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_dream_41775 API",
    "DESCRIPTION": "API documentation for round_dream_41775 App",
    "VERSION": "v1",
}
